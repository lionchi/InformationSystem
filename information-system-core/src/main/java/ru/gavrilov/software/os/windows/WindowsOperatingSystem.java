...
import ru.gavrilov.software.common.AbstractOperatingSystem;
...
public class WindowsOperatingSystem extends AbstractOperatingSystem {
    ...
    private final static WmiUtil.ValueType[] processPropertyTypes = { WmiUtil.ValueType.STRING, WmiUtil.ValueType.STRING, WmiUtil.ValueType.STRING,
            WmiUtil.ValueType.UINT32, WmiUtil.ValueType.UINT32, WmiUtil.ValueType.UINT32, WmiUtil.ValueType.UINT32, WmiUtil.ValueType.UINT32, WmiUtil.ValueType.STRING,
            WmiUtil.ValueType.STRING, WmiUtil.ValueType.STRING, WmiUtil.ValueType.STRING, WmiUtil.ValueType.DATETIME, WmiUtil.ValueType.UINT64,
            WmiUtil.ValueType.UINT64, WmiUtil.ValueType.UINT32, WmiUtil.ValueType.PROCESS_GETOWNER, WmiUtil.ValueType.PROCESS_GETOWNERSID };
